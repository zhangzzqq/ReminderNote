...
//        notifyDataSetChanged();
     ...
     */
    public void setChangeStatus(int finishPosition,boolean flag){

     MessageContent messageContent =  mDatas.get(finishPosition);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        MessageContent messageContent = mDatas.get(holder.getAdapterPosition());
